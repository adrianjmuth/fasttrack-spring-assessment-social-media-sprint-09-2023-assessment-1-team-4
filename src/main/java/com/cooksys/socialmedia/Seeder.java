...
//	    // ----- TWEETS -----
        ...
        tweet1.setUsersMentioned(Arrays.asList(user1, user2));
        ...
        tweet5.setUsersMentioned(Arrays.asList(user1, user2));
        ...
        deletedTweet.setUsersMentioned(Arrays.asList(user1, user2));
